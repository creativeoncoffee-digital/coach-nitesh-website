...
export default function Certification() {
  return (
    <section className="py-16 md:py-22 relative z-10 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-20 items-center">
          ...
          >
            ...
            <motion.ul variants={staggerContainer} className="space-y-6 mb-12">
              ...
              <motion.li variants={fadeUp} className="flex items-center gap-5 group cursor-default">
                <div className="w-14 h-14 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-[var(--color-brand-orange)] group-hover:bg-[var(--color-brand-orange)]/10 group-hover:border-[var(--color-brand-orange)]/30 group-hover:scale-110 transition-all duration-300 shadow-lg">
          ...
          <motion.div 
            ...
            className="relative perspective-1000 md:ml-10"
          >
            <motion.div 
              animate={{ y: [0, -15, 0] }} 
